...
def scanPort(port):
    ...
    for host in hostResults:
            tcpconn = nmap.nmap_tcp_scan(host["address"], args="-Pn -p " + port)
            ...
            tcpsyn = nmap.nmap_syn_scan(host["address"], args="-Pn -p " + port)
            ...
            tcpfin = nmap.nmap_fin_scan(host["address"], args="-Pn -p " + port)
            ...
            tcpxmas = nmaphd.nmap_portscan_only(host["address"], args="-Pn -p " + port)
            ...
            tcpnull = nmaphd.nmap_portscan_only(host["address"], args="-Pn -p " + port)
            ...
            tcpack = nmaphd.nmap_portscan_only(host["address"], args="-Pn -p " + port)
            print(tcpack)
